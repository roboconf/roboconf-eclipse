 ...
 * </p>
 * <ul>
 *   <li>{@link net.roboconf.eclipse.occi.graph.roboconfgraph.impl.RoboconfFacetImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RoboconfFacetImpl extends ResourceImpl implements RoboconfFacet {
	/**
	...
	protected EClass eStaticClass() {
		return RoboconfgraphPackage.Literals.ROBOCONF_FACET;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RoboconfgraphPackage.ROBOCONF_FACET__NAME, oldName, name));
	}
