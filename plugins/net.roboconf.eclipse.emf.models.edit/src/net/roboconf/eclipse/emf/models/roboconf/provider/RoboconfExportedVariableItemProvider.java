...
/**
 * This is the item provider adapter for a {@link net.roboconf.eclipse.emf.models.roboconf.RoboconfExportedVariable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RoboconfExportedVariableItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addExternalAliasPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RoboconfExportedVariable_defaultValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RoboconfExportedVariable_defaultValue_feature", "_UI_RoboconfExportedVariable_type"),
				 RoboconfEmfPackage.Literals.ROBOCONF_EXPORTED_VARIABLE__DEFAULT_VALUE,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the External Alias feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addExternalAliasPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RoboconfExportedVariable_externalAlias_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RoboconfExportedVariable_externalAlias_feature", "_UI_RoboconfExportedVariable_type"),
				 RoboconfEmfPackage.Literals.ROBOCONF_EXPORTED_VARIABLE__EXTERNAL_ALIAS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RoboconfEmfPackage.Literals.ROBOCONF_EXPORTED_VARIABLE__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
