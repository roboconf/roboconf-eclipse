...
/**
 * This is the item provider adapter for a {@link net.roboconf.eclipse.emf.models.roboconf.RoboconfImportedVariable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RoboconfImportedVariableItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RoboconfEmfPackage.Literals.ROBOCONF_IMPORTED_VARIABLE__OPTIONAL,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RoboconfEmfPackage.Literals.ROBOCONF_IMPORTED_VARIABLE__EXTERNAL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RoboconfEmfPackage.Literals.ROBOCONF_IMPORTED_VARIABLE__NAME,
				 true,
				 false,
				 false,
